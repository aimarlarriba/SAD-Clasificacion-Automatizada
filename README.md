...
* **`configuration.json`**: Fichero centralizado donde se definen las estrategias de preproceso (nulos, escalado, balanceo) y los rangos de hiperparámetros.
* **`bestmodel.sav`**: Archivo binario que contiene el mejor modelo entrenado mediante `pickle`[cite: 120, 125, 213, 220].
